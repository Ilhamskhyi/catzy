...
function title() {
	...
	console.log(chalk.yellow(`\n                        ${chalk.yellow('[ Created By ilham - skhyzi]')}\n\n${chalk.red('Catzy - Bot')} : ${chalk.white('WhatsApp Bot Multi Device')}\n${chalk.red('Follow Insta skhyzi')} : ${chalk.white('ilham - skhyzi')}\n${chalk.red('Message Me On WhatsApp')} : ${chalk.white('+687710621')}\n${chalk.red('Donate')} : ${chalk.white('687710621 ( Gopay/Pulsa )')}\n`))
}
